...
async def connect(device: bleak.backends.device.BLEDevice):
    ...
    try:
        async with BleakClient(address_or_ble_device= device) as client:
            ...
            client.write_gatt_char(FLAG_CHAR, b'\x01')
    ...
    except (asyncio.exceptions.CancelledError) as e:print("Exception asyncio.exceptions.CancelledError occured while connecting: ", e)
